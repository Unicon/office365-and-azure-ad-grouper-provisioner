...
if [ "$arg1" != "-initEnv" ]; then
	...
	${JAVA} -Xms$MEM_START -Xmx$MEM_MAX -Dgrouper.home="$GROUPER_HOME/" $GSH_JVMARGS -classpath "${GROUPER_CP}" $GSH -main edu.internet2.middleware.changelogconsumer.googleapps.GoogleAppsFullSync $*
